...
namespace SteamStorage.Utilities
{
    public static class Context
    {
        ...
        {
            return remainModels.Where(x => groupModel is null || groupModel.RemainGroup is null || x.RemainGroup == groupModel.RemainGroup);
        }
        public static IEnumerable<ArchiveModel> GetArchiveModels(ArchiveGroupModel? groupModel)
        {
            return archiveModels.Where(x => groupModel is null || groupModel.ArchiveGroup is null || x.ArchiveGroup == groupModel.ArchiveGroup);
        }
        #endregion Methods
    }
}